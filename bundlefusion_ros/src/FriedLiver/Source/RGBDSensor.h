...
public:
	...
	// virtual bool myProcessDepth(cv_bridge::CvImageConstPtr *pColorImage, cv_bridge::CvImageConstPtr *pDepthImage){return true;}
	...
	//void recordFrame(); change by guan
	...
	//void saveRecordedFramesToFile(const std::string& filename, const std::vector<mat4f>& trajectory, bool overwriteExistingFile = false);//change by guan
